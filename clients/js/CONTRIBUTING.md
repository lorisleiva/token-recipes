...
This is a quick guide to help you contribute to the JavaScript client of Token Recipes.
...
- `VERCEL_PROJECT_ID` — The ID of the Vercel project you want to deploy to.
  The convention for Metaplex is to create a new Vercel project named `token-recipes-js-docs` with the following deployment settings:
