...
EXTERNAL_ID=("SysExL2WDyJi9aRZrXorrjHJut3JwHQ7R9bTyctbNNG" "metaqbxxUerdq28cj1RbAWkYQm3ybzjb6a8bt518x1s")
EXTERNAL_SO=("mpl_system_extras.so" "mpl_token_metadata.so")
